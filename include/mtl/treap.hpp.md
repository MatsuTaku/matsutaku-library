...
data:
  ...
  code: "#pragma once\r\n#include <memory>\r\n#include <iterator>\r\n#include <cassert>\r\
    ...
    \ T, class V=void,\r\n    class Compare = std::less<>,\r\n    bool UniqueKey =\
    \ true>\r\nclass Treap {\r\n public:\r\n  using key_type = T;\r\n  static constexpr\
    \ bool kKeyOnly = std::is_same<V, void>::value;\r\n  using mapped_type = typename\
    \ std::conditional<kKeyOnly, T, V>::type;\r\n  using value_type = typename std::conditional<\r\
    \n      kKeyOnly,\r\n      T,\r\n      std::pair<T const, V>\r\n  >::type;\r\n\
    \  using raw_key_type = typename std::conditional<kKeyOnly, T, typename std::remove_const<T>::type>::type;\r\
