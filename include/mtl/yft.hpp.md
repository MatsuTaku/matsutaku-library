...
data:
  ...
  bundledCode: "#line 2 \"include/mtl/binary_trie.hpp\"\n#include <array>\r\n#include\
    ...
    \n//      size_(rhs.size_),\r\n//      dist_(0, W-1) {}\r\n//  YFastTrieBase&\
    \ operator=(const YFastTrieBase& rhs) {\r\n//    xft_ = rhs.xft_;\r\n//    end_\
    \ = iterator(&xft_, std::prev(xft_.end()), std::prev(xft_.end())->second.end());\r\
    \n//    size_ = rhs.size_;\r\n//    eng_ = rhs.eng_;\r\n//    dist_ = rhs.dist_;\r\
    ...
    \ (e != end and (px == Def::key_of(*e) or !_pivot_selected())) {\r\n        px\
    \ = Def::key_of(*(e++));\r\n      }\r\n      if (e != end) {\r\n        key_type\
