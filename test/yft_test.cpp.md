...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"test/yft_test.cpp\"\n#include <yft.hpp>\r\n#line 1 \"test/set_test.hpp\"\
    \n#include <iostream>\r\n#include <vector>\r\n#include <algorithm>\r\n#include\
    \ <type_traits>\r\n#include <cassert>\r\n#include <set>\r\n\r\nnamespace mtl {\r\
    \n\r\nusing std::cout;\r\nusing std::cerr;\r\nusing std::endl;\r\n\r\ntemplate<class\
    ...
    \ ok\"<<endl;\r\n}\r\n\r\n}\r\n#line 3 \"test/yft_test.cpp\"\n\r\nint main() {\r\
    \n  mtl::integer_set_test<YFastTrieSet<unsigned, 20>, 1<<20>();\r\n  mtl::integer_set_test<YFastTrieSet<unsigned,\
    \ 20>, 1<<20, false>();\r\n  mtl::map_emplace_test<YFastTrieMap<unsigned, std::vector<int>>>();\r\
    \n  std::cout << \"OK\" << std::endl;\r\n}\r\n"
  code: "#include <yft.hpp>\r\n#include \"set_test.hpp\"\r\n\r\nint main() {\r\n \
    \ mtl::integer_set_test<YFastTrieSet<unsigned, 20>, 1<<20>();\r\n  mtl::integer_set_test<YFastTrieSet<unsigned,\
    \ 20>, 1<<20, false>();\r\n  mtl::map_emplace_test<YFastTrieMap<unsigned, std::vector<int>>>();\r\
    \n  std::cout << \"OK\" << std::endl;\r\n}\r\n"
  dependsOn:
  ...
  verifiedWith: []
documentation_of: test/yft_test.cpp
layout: document
redirect_from:
- /library/test/yft_test.cpp
- /library/test/yft_test.cpp.html
